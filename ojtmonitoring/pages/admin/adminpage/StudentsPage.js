            ...
            <tbody className="text-gray-700">
              {students.map((s) => (
                <tr key={s.id} className="hover:bg-blue-50 transition-colors">
                  <td className="border px-4 py-3">{s.first_name} {s.last_name}</td>
                  <td className="border px-4 py-3">{s.email}</td>
                  <td className="border px-4 py-3">{s.student_id}</td>
          ...
          <div className="fixed inset-0 z-50 bg-gray-600 bg-opacity-50 flex items-center justify-center">
            <div className="bg-white rounded-lg p-8 w-full max-w-lg shadow-xl">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <label htmlFor="disabled" className="inline-flex items-center">
                    <input
                      type="checkbox"
                      id="disabled"
                      name="disabled"
