    ...
    <div>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-blue-800 to-transparent">
          <div className="pl-6 sm:pl-16 md:pl-[200px] flex flex-col h-full justify-center">
            <h2 className="text-3xl sm:text-4xl text-white font-bold">Bachelor of Science in Criminology (BSCrim)</h2>
            <h2 className="text-3xl sm:text-4xl text-yellow-300 font-bold">OJT Monitoring System</h2>
            <p className="mt-2 text-sm sm:text-base w-[300px] sm:w-[600px] text-white">
      ...
      {/* ABOUT US AREA */}
      <section id="AboutUsSection" className="p-6 sm:p-8 w-full h-[700px] flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-40 sm:pl-[150px] sm:pr-[150px]">
        <div>
          <h2 className="text-3xl sm:text-4xl text-blue-500 font-bold">About Us</h2>
          <p className="text-base sm:text-lg text-black mt-4 sm:mt-8">
        ...
        <div>
          <img src="Images/Ojt_Meeting_Image.jpg" alt="OJT MEETING" className="w-full sm:w-auto" />
        </div>
      </section>

      {/* CONTACT US SECTION */}
      <section id="ContactUsSection" className="bg-blue-50 min-h-screen pt-16 sm:pt-28 pb-16 px-6 sm:px-40">
        <h1 className="text-3xl sm:text-4xl font-bold text-blue-800 mb-4 text-center">Contact Us</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-8 sm:gap-10 justify-between">
          {/* Contact Form */}
          <form className="bg-white p-6 sm:p-8 shadow-md rounded-lg w-full sm:w-1/2">
            <div className="mb-4">
          ...
          {/* Contact Info */}
          <div className="bg-white p-6 sm:p-8 shadow-md rounded-lg w-full sm:w-1/2">
